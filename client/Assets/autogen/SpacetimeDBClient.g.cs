...
namespace SpacetimeDB.Types
{
    ...
    public sealed partial class RemoteTables : RemoteTablesBase
    {
        public RemoteTables(DbConnection conn)
        {
            ...
            AddTable(ColorSpellAction = new(conn));
            AddTable(ColorSpellState = new(conn));
    ...
    public sealed class DbConnection : DbConnectionBase<DbConnection, RemoteTables, Reducer>
    {
        ...
        protected override Reducer ToReducer(TransactionUpdate update)
        {
            ...
            {
                "ApplyColorSpell" => BSATNHelpers.Decode<Reducer.ApplyColorSpell>(encodedArgs),
                "Connect" => BSATNHelpers.Decode<Reducer.Connect>(encodedArgs),
                "CreateColorSpellAction" => BSATNHelpers.Decode<Reducer.CreateColorSpellAction>(encodedArgs),
                "CreateDummyPlayer" => BSATNHelpers.Decode<Reducer.CreateDummyPlayer>(encodedArgs),
                ...
                "DoColorSpellAction" => BSATNHelpers.Decode<Reducer.DoColorSpellAction>(encodedArgs),
                ...
                "TestSingle" => BSATNHelpers.Decode<Reducer.TestSingle>(encodedArgs),
        ...
        protected override bool Dispatch(IReducerEventContext context, Reducer reducer)
        {
            ...
            {
                Reducer.ApplyColorSpell args => Reducers.InvokeApplyColorSpell(eventContext, args),
                Reducer.Connect args => Reducers.InvokeConnect(eventContext, args),
                Reducer.CreateColorSpellAction args => Reducers.InvokeCreateColorSpellAction(eventContext, args),
                Reducer.CreateDummyPlayer args => Reducers.InvokeCreateDummyPlayer(eventContext, args),
                ...
                Reducer.DoColorSpellAction args => Reducers.InvokeDoColorSpellAction(eventContext, args),
                ...
                Reducer.TestSingle args => Reducers.InvokeTestSingle(eventContext, args),
